...
export const tools: Tool[] = [
  ...
  { slug: 'json-minifier', title: 'JSON Minifier', description: 'Compress JSON by removing whitespace.', component: 'JsonMinifier', category: 'dev', icon: 'Minimize2', iconColor: 'text-blue-600 bg-blue-600/10', themeColor: 'blue' },
  { slug: 'json-escape', title: 'JSON Escape', description: 'Convert JSON to escaped string.', component: 'JsonEscape', category: 'dev', icon: 'FileCode', iconColor: 'text-indigo-600 bg-indigo-600/10', themeColor: 'indigo' },
  { slug: 'json-unescape', title: 'JSON Unescape', description: 'Reverse JSON escape to valid JSON.', component: 'JsonUnescape', category: 'dev', icon: 'FileText', iconColor: 'text-cyan-600 bg-cyan-600/10', themeColor: 'cyan' },
  { slug: 'json-compare', title: 'JSON Compare', description: 'Compare two JSON objects side by side.', component: 'JsonCompare', category: 'dev', icon: 'Diff', iconColor: 'text-slate-600 bg-slate-600/10', themeColor: 'slate' },
  { slug: 'json-viewer', title: 'JSON Viewer', description: 'Interactive tree view for JSON data.', component: 'JsonViewer', category: 'dev', icon: 'Eye', iconColor: 'text-blue-500 bg-blue-500/10', themeColor: 'blue' },
  { slug: 'json-to-yaml', title: 'JSON → YAML', description: 'Convert JSON data to YAML format.', component: 'JsonToYaml', category: 'dev', icon: 'RefreshCw', iconColor: 'text-blue-400 bg-blue-400/10', themeColor: 'blue' },
  { slug: 'json-to-xml', title: 'JSON → XML', description: 'Convert JSON data to XML format.', component: 'JsonToXml', category: 'dev', icon: 'Code', iconColor: 'text-indigo-400 bg-indigo-400/10', themeColor: 'indigo' },
  { slug: 'json-to-csv', title: 'JSON → CSV', description: 'Convert JSON array to CSV format.', component: 'JsonToCsv', category: 'dev', icon: 'Table', iconColor: 'text-cyan-400 bg-cyan-400/10', themeColor: 'cyan' },
  ...
  { slug: 'duplicate-word-remover', title: 'Remove Duplicate Words', description: 'Remove repeated words from your text.', component: 'DuplicateWordRemover', category: 'text', icon: 'CopyCheck', iconColor: 'text-yellow-400 bg-yellow-400/10', themeColor: 'yellow' },
  { slug: 'find-replace', title: 'Find and Replace', description: 'Search and replace text with regex support.', component: 'FindReplace', category: 'text', icon: 'Search', iconColor: 'text-orange-500 bg-orange-500/10', themeColor: 'orange' },
  { slug: 'line-counter', title: 'Line Counter', description: 'Detailed line, empty line and length stats.', component: 'LineCounter', category: 'text', icon: 'ListOrdered', iconColor: 'text-amber-500 bg-amber-500/10', themeColor: 'amber' },
  { slug: 'sentence-counter', title: 'Sentence Counter', description: 'Count sentences and paragraphs accurately.', component: 'SentenceCounter', category: 'text', icon: 'Type', iconColor: 'text-yellow-500 bg-yellow-500/10', themeColor: 'yellow' },
  { slug: 'reading-time', title: 'Reading Time Calculator', description: 'Calculate reading and speaking time.', component: 'ReadingTime', category: 'text', icon: 'Timer', iconColor: 'text-orange-400 bg-orange-400/10', themeColor: 'orange' },
  { slug: 'markdown-preview', title: 'Markdown Preview', description: 'Real-time Markdown editor and previewer.', component: 'MarkdownPreview', category: 'text', icon: 'FileCode', iconColor: 'text-blue-500 bg-blue-500/10', themeColor: 'blue' },
  { slug: 'markdown-to-html', title: 'Markdown → HTML', description: 'Convert Markdown to clean, minified HTML.', component: 'MarkdownPreview', category: 'text', icon: 'FileJson', iconColor: 'text-emerald-500 bg-emerald-500/10', themeColor: 'emerald' },
  { slug: 'html-to-markdown', title: 'HTML → Markdown', description: 'Convert HTML back to clean Markdown.', component: 'MarkdownPreview', category: 'text', icon: 'FileText', iconColor: 'text-orange-500 bg-orange-500/10', themeColor: 'orange' },
  { slug: 'text-compare', title: 'Text Compare', description: 'Compare two text blocks and find diffs.', component: 'TextCompare', category: 'text', icon: 'Diff', iconColor: 'text-slate-500 bg-slate-500/10', themeColor: 'slate' },
