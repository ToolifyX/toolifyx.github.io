...
export const tools: Tool[] = [
  ...
  { slug: 'png-to-jpg', title: 'PNG to JPG', description: 'Convert PNG images to JPG instantly.', component: 'PngToJpg', category: 'image', icon: 'RefreshCw' },
  { slug: 'jpg-to-png', title: 'JPG to PNG', description: 'Convert JPG images to PNG instantly.', component: 'JpgToPng', category: 'image', icon: 'RefreshCw' },
  { slug: 'jpg-to-webp', title: 'JPG to WebP', description: 'Convert JPG images to WebP format.', component: 'JpgToWebp', category: 'image', icon: 'RefreshCw' },
  { slug: 'webp-to-jpg', title: 'WebP to JPG', description: 'Convert WebP images to JPG format.', component: 'WebpToJpg', category: 'image', icon: 'RefreshCw' },
  { slug: 'png-to-webp', title: 'PNG to WebP', description: 'Convert PNG images to WebP format.', component: 'PngToWebp', category: 'image', icon: 'RefreshCw' },
  { slug: 'webp-to-png', title: 'WebP to PNG', description: 'Convert WebP images to PNG format.', component: 'WebpToPng', category: 'image', icon: 'RefreshCw' },
