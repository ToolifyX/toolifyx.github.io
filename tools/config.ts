...
export const tools: Tool[] = [
  ...
  { slug: 'convert-to-png', title: 'Convert to PNG', description: 'Convert JPG, WebP, SVG and more to PNG format instantly.', component: 'ConvertToPng', category: 'image', icon: 'RefreshCw' },
  { slug: 'convert-to-jpg', title: 'Convert to JPG', description: 'Convert PNG, WebP, HEIC, AVIF and more to JPG format instantly.', component: 'ConvertToJpg', category: 'image', icon: 'RefreshCw' },
