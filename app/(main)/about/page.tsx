...
const sections = [
  {
    ...
    title: "Privacy First",
    description: "Unlike other online tools, PhungX processes all your data locally in your browser. Your files and information never leave your device. No uploads, no servers, no tracking."
  },
  {
    ...
    <div className="max-w-4xl mx-auto px-4 py-16 space-y-20">
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          PhungX is a collection of 100+ browser-native utilities designed to make your digital life easier without compromising your data security.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
              ...
              <p>
                <strong>PhungX was created to change that.</strong>
              </p>
              <p>
          ...
          <div className="bg-primary/5 rounded-3xl p-8 flex flex-col justify-center border border-primary/10">
             ...
             <p className="text-sm text-muted-foreground leading-relaxed">
               PhungX uses modern web technologies like WebAssembly, Client-side JS, and Local Storage to ensure everything happens right in your browser tab.
             </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8 text-center bg-muted/30 rounded-[3rem] p-12">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          We're always looking for ways to improve PhungX. Reach out to us for support, feature requests, or just to say hi!
        </p>
